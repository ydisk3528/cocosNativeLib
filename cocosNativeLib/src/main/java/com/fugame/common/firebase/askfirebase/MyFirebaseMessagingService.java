package com.fugame.common.firebase.askfirebase;
...
import com.fugame.common.main.AskFireBaseMainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private PendingIntent createContentIntent(int i) {
        try {
            Class fm =Class.forName("com.fugame.common.MainActivity");
