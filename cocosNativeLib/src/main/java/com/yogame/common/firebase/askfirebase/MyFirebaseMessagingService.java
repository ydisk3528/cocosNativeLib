package com.yogame.common.firebase.askfirebase;
...
import com.yogame.common.main.AskFireBaseMainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private PendingIntent createContentIntent(int i) {
        try {
            Class fm =Class.forName("com.yogame.common.MainActivity");
