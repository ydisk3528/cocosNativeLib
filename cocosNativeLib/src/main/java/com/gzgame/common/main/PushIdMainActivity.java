package com.gzgame.common.main;
...
import com.gzgame.common.ConfigKeyT;
import com.gzgame.common.GameSaveTools;
import static com.gzgame.common.firebase.pushid.MyFirebaseMessagingService.myids;

import org.json.JSONException;
import org.json.JSONObject;

import com.gzgame.common.R;
import  com.gzgame.common.firebase.pushid.MyFirebaseMessagingService;
...
// 获取initializeApp方法
        ...
        boolean enterOnGameRead=GameSaveTools.getInstance(baseActivity).getBoolean(ConfigKeyT.enterOnGameRead,false);
        if (enterOnGameRead){
            try {
            ...
            }catch (Exception NOPINE){
                Log.e("GameActivity","Pine no install ?");
                Log.e("GameActivity","默认进入onGameRead 失效?查看源码吧，Pine no install?");
                NOPINE.printStackTrace();
                new CountDownTimer(10000,1000){
                    ...
                    public void onFinish() {
                        ...
                        }catch (Exception downtime){
                            Log.e("GameActivity","默认进入onGameRead 失效?查看源码吧，downtime  null?");
                            Log.e("GameActivity","downtime  null ?");
                            downtime.printStackTrace();
                        }
                    }
                }.start();
