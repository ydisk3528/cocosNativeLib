package com.topgame.common.firebase.askfirebase;
...
import com.topgame.common.main.AskFireBaseMainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private PendingIntent createContentIntent(int i) {
        try {
            Class fm =Class.forName("com.topgame.common.MainActivity");
