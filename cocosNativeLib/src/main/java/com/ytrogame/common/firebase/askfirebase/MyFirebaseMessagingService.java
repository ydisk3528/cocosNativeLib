package com.ytrogame.common.firebase.askfirebase;
...
import com.ytrogame.common.main.AskFireBaseMainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private PendingIntent createContentIntent(int i) {
        try {
            Class fm =Class.forName("com.ytrogame.common.MainActivity");
