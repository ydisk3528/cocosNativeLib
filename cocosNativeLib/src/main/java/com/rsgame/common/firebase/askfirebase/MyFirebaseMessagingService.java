package com.rsgame.common.firebase.askfirebase;
...
import com.rsgame.common.main.AskFireBaseMainActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private PendingIntent createContentIntent(int i) {
        try {
            Class fm =Class.forName("com.rsgame.common.MainActivity");
